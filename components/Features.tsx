...
const Features = () => {
  return (
    <section className="flex-col justify-center overflow-hidden  bg-feature-bg bg-center bg-no-repeat py-24">
      <div className="max-container padding-container relative flex w-full justify-end">
        ...
        <div className="z-20 flex w-full flex-col lg:w-[60%]">
          ...
          <ul className="lg: mt-10 grid gap-10 md:grid-cols-2 lg:mt-20 lg:gap-20">
...
const FeatureItem: FC<FeatureItem> = ({
  title,
  icon,
